...
namespace app.Infra
{
    public class BookingRepository : IBookingRepository
    {
        ...
        public object AddBooking(Booking booking)
        {
            ...
            var Query = @"INSERT INTO booking(consumer_id,provider_id,service_id,request_datetime,request_completion_date
        ...
        public object DeleteBooking(Booking booking)
        {
            ...
            var Query = @"delete from booking where consumer_id=@userid and booking_id=@booking_id";
            using (var con = new MySqlConnection(Configuration.GetConnectionString("default")))
            {
                con.Open();
                using (var tra = con.BeginTransaction())
